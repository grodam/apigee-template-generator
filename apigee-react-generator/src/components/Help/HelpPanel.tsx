            ...
            <div>
              ...
              <div className="space-y-4">
                {autoGeneratedFields.map((field, index) => (
                  <div key={index} className="bg-[var(--bg-primary)] border-l-2 border-amber-500 pl-3 py-2">
                    <p className="text-xs font-bold text-[var(--text-primary)] mb-1">{field.name}</p>
                    <p className="text-xs text-[var(--text-secondary)] leading-relaxed">{field.description}</p>
                    {field.format && (
